...
function tt_GetDiv(t_id)
{
	return(
		...
		: tt_ie? (document.getElementById(t_id) || null)
...
/*	return(
		...
		: (document.getElementById(t_id) || null)
	); 16.05.2007 - fix to get tooltip to work in an update panel, suspect that document.all[t_id] isn't redone after asynch postback */	
}
function tt_GetDivW()
{
	return tt_Int(
