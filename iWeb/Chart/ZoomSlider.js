...
function ZoomSlider(diagram, options) {
    ...
    this._size = 125;
    this._buttonSize = 25;
    this._alignment = go.Spot.TopLeft;
    this._alignmentFocus = go.Spot.TopLeft;
...
ZoomSlider.prototype.sliderDivSetup = function () {
    ...
    zoomOutBtn.type = "button";     // added AP 
    ...
    zoomInBtn.innerHTML = '+';
    zoomInBtn.type = "button";      // added AP 
...
ZoomSlider.prototype.resize = function (reorient) {
    ...
    if (this.orientation === 'horizontal') {
       ...
       // zoomOutBtn.style.backgroundColor='#00ff90';
       ...
       // zoomInBtn.style.backgroundColor = '#00ff90';
