...
Namespace IAW.controls
    ...
    <ToolboxData("<{0}:IAWRequiredFieldValidator runat=server></{0}:IAWRequiredFieldValidator>")>
    Public Class IAWRequiredFieldValidator
        ...
        Public Property TranslateErrorMessage As Boolean
            Get
                If ViewState("TranslateErrorMessage") Is Nothing Then
                    Return True
                End If
                Return Convert.ToBoolean(ViewState("TranslateErrorMessage"))
            End Get
        ...
        Public Property AddBR As Boolean
            Get
                If ViewState("AddBR") Is Nothing Then
                    Return False
                End If
                Return Convert.ToBoolean(ViewState("AddBR"))
            End Get
            Set(value As Boolean)
