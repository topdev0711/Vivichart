        ...
        (function (Features) {
            ...
            var TableOfContentsDocumentFeature = /** @class */ (function (_super) {
                ...
                TableOfContentsDocumentFeature.prototype.syncTocNodeToUrl = function (url) {
                    ...
                    var anchor = $("div#i-toc-container > ul a[href=\"".concat(decodeURIComponent(url), "\"]"), this._rootSelector).first();
                    if (anchor != null
                        && anchor.length
        ...
        (function (Features) {
            ...
            var SearchDocumentFeature = /** @class */ (function (_super) {
                ...
                SearchDocumentFeature.prototype.buildSearchResults = function () {
                        ...
                        if (token.length > 0) {
                            ...
                            if (token != null) {
                                ...
                                if ((token === "or") || (token === "and")) {
                                    ...
                                    // add to query string
                                    query += ("(searchTerms.indexOf(\"".concat(token, "\") >= 0)"));
                    ...
                    var searchResults = this.populateSearchResults(searchFiles, allWordsDiact, searchTerms);
                    // build results list
                ...
                SearchDocumentFeature.prototype.populateSearchResults = function (searchFiles, allWords, searchTerms) {
                    ...
                    var _loop_1 = function (searchTerm) {
                        ...
                        if (searchTerm.indexOf(" ") !== -1) {
                                            ...
                                            if (typeof searchResult !== "undefined" && searchResult.fileIndex === baseResult.fileIndex) {
                                                ...
                                                var _loop_3 = function (thisKeyword) {
                                                    if (thisKeyword !== "") {
                                                        ...
                                                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                                                        $.map((baseResult.keywordPositions[("_".concat(firstSearchTermWord_1))]), function (basePosition) {
                                                            var matchingKeywordPositions 
                                                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                                                            = $.map(searchResult.keywordPositions[("_".concat(thisKeyword))], function (position) {
                                                        ...
                                                        if (matchingBasePositions.length > 0) {
                                                            ...
                                                            baseResult.searchTerms = "".concat(searchTerm, ",");
                            ...
                            for (var _a = 0, searchTermWords_1 = searchTermWords; _a < searchTermWords_1.length; _a++) {
                                var searchTermWord = searchTermWords_1[_a];
                            ...
                            var searchTermRegExp = new RegExp("^".concat(SearchDocumentFeature.escapeForRegEx(searchTerm)
                                .replace(/\*/g, ".*")
                                .replace(/\?/g, "."), "$"), "i");
                            for (var word in allWords) {
                            ...
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            if (typeof allWords["_".concat(searchTerm)] !== "undefined") {
                        ...
                        if (searchTermWordMatch != null) {
                            ...
                            for (var _b = 0, _c = searchTermWordMatch.matchedWords; _b < _c.length; _b++) {
                                var matchedWord = _c[_b];
                                // get indices of files containing word
                                /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                                var matchedWordData = allWords["_".concat(searchTermWordMatch.matchedWords[searchTermWordMatchIndex])];
                                // tokenize indices
                                var fileIndexes = matchedWordData.split(",");
                                for (var _d = 0, fileIndexes_1 = fileIndexes; _d < fileIndexes_1.length; _d++) {
                                    var fileIndexValue = fileIndexes_1[_d];
                                    ...
                                    if (typeof searchResults[fileIndex] === "undefined") {
                                        ...
                                        locatedSearchResult = new SearchResult(fileIndex, rank, "".concat(matchedWord, ","), "".concat(searchTermWordMatch.searchTerm, ","));
                                        ...
                                        if (locatedSearchResult.keywords.indexOf("".concat(matchedWord, ",")) === -1) {
                                            // New word match in this file
                                            locatedSearchResult.rank += rank;
                                            locatedSearchResult.keywords += ("".concat(matchedWord, ","));
                                        }
                                        if (locatedSearchResult.searchTerms.indexOf("".concat(searchTermWordMatch.searchTerm, ",")) === -1) {
                                            // New search term match in this file
                                            locatedSearchResult.rank += rank;
                                            locatedSearchResult.searchTerms += ("".concat(searchTermWordMatch.searchTerm, ","));
                                        }
                                    }
                                    if (positions != null) {
                                        ...
                                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                                        locatedSearchResult.keywordPositions[("_".concat(matchedWord))] = positions;
                                    }
                                }
                ...
                SearchDocumentFeature.prototype.outputResults = function (searchResults) {
                    ...
                    for (var _i = 0, searchResults_2 = searchResults; _i < searchResults_2.length; _i++) {
                        ...
                        if (typeof searchResult !== "undefined") {
                            ...
                            // add row text
                            tableHtml += "<tr><td class=\"".concat(className, "\">").concat(resultCount + 1, ":</td><td class=\"").concat(className, "\"><a class=\"i-result btn\" ").concat(!this._isFullTextSearchFrameless ? "target=\"i-content\" " : "", "href=\"").concat(searchResult.searchFile.url, "\" data-result-index=\"").concat(resultCount, "\">").concat(searchResult
                    ...
                    // add footer
                    tableHtml += "</table><p>".concat(resultCount, " ").concat(this.getPhrase("Search_ResultCount"), "</p>");
                    // set it
                ...
                SearchDocumentFeature.prototype.showSearchResult = function (hRef, resultIndex) {
                    ...
                    if (!this._isFullTextSearchFrameless && webframe != null) {
                        ...
                        if (resultIndex != null && highlight.is(":checked")) {
                            ...
                            hRef = "".concat(hRef, "?highlight=").concat(encodeURIComponent(clickedResult.keywords));
                        }
